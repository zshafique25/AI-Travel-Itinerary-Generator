...
class GeminiModel:
    ...
    def create_prompt(self, responses):
        ...
        prompt = (
            ...
            "    - Ensure all recommendations fit within the specified budget in Pakistani Rupees (PKR).\n"
            "    - Provide cost estimates for major expenses (accommodations, transportation, activities) in PKR.\n"
            "    - Consider local prices and exchange rates when making recommendations.\n\n"
